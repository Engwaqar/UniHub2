...
import { logoutUser, SigInAsGuest } from "../redux/actions/user.actions";
...
export default function MainHeader({
  ...
  const SignInAsGuest = async () => {
    ...
    // navigation.navigate(routeName.BOTTOM_TABS, { screen: routeName.HOME });
      ...
      },
      {
        ...
        onPress: async () => {
          ...
          await navigation.dispatch(
            StackActions.replace(routeName.AUTH_STACK, {
              screen: routeName.LOGIN,
            })
          );
      ...
      >
        ...
        {cartIcon ? (
          ...
          <TouchableOpacity onPress={toggel}>
            <ResponsiveText weight={"bold"} color={colors.red}>
              Log Out
            </ResponsiveText>
          </TouchableOpacity>
        ) : ScanButton ? (
          ...
          >
           <Icon size={35} source={globalPath.QR_CODE} />
          </TouchableOpacity>
        ) : (
          <Icon size={35} />
        )}
