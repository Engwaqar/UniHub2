import { Alert, Image, Linking, StyleSheet, Text, TouchableOpacity, View ,ScrollView} from "react-native";
    ...
    <SafeAreaView>
      ...
      <ScrollView>
        ...
        <SmallButton
          ...
          margin={[10, 0, 10, 0]}
          title={ MyProfile.is_seller == 0 ? "Add Bank Details" : "Switch to Buyer" }
          ...
          {tabsData.map((item) => (
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    item.id == activeTab ? colors.primary : colors.white,
                },
              ]}
